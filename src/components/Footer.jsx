      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li>
                <Link to="/endowment">Endowment</Link>
              </li>
              <li>
                <Link to="/policies-and-safety">Policies</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="social-links">
            ...
            <a
              href="https://www.instagram.com/fort_kent_outdoor_center/"
              className="social-link"
            ...
            <a
              href="https://github.com/BrandonGoding/www_fortkentoc_org"
              className="social-link"
              aria-label="GitHub"
              target="_blank"
              rel="noopener noreferrer"
