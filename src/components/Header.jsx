    ...
    <nav className="nav-header">
      <div className="nav-container">
        ...
        <div className={`nav-menu ${mobileMenuOpen ? 'nav-menu-open' : ''}`} id="mobile-menu">
          <ul className="nav-list">
            ...
            <li className="nav-item nav-item-dropdown">
              ...
              <div
                className={`nav-dropdown ${openDropdown === 'about' ? 'nav-dropdown-open' : ''}`}
              >
                <ul className="nav-dropdown-list">
                  ...
                  <li>
                    <Link to="/facilities" onClick={closeAll}>
                      Facilities
                    </Link>
                  </li>
                  <li>
                    <Link to="/trails" onClick={closeAll}>
                      Trails
                    </Link>
                  </li>
                  <li>
                    <Link to="/endowment" onClick={closeAll}>
                      Endowment
                    </Link>
                  </li>
                  <li>
                    <Link to="/policies-and-safety" onClick={closeAll}>
                      Policies
                    </Link>
                  </li>
                </ul>
            ...
            <li className="nav-item nav-item-dropdown">
              ...
              <div
                className={`nav-dropdown ${openDropdown === 'programs' ? 'nav-dropdown-open' : ''}`}
              >
                <ul className="nav-dropdown-list">
                  <li>
                    <Link to="/coaching-programs#fkoc-coaching" onClick={closeAll}>
                      Coaches
                    </Link>
                  </li>
                  <li>
                    <Link to="/coaching-programs#pg-training" onClick={closeAll}>
                      (PG) Training Program
                    </Link>
                  </li>
                  <li>
                    <Link to="/coaching-programs#residence" onClick={closeAll}>
                      Jalbert Biathlon Residence
                    </Link>
                  </li>
                  <li>
                    <Link to="/coaching-programs#ski-program" onClick={closeAll}>
                      Jalbert Ski Program
                    </Link>
                  </li>
                  <li>
                    <Link to="/coaching-programs#biathlon-program" onClick={closeAll}>
            ...
            <li className="nav-item nav-item-dropdown">
              ...
              <div
                className={`nav-dropdown ${openDropdown === 'trails' ? 'nav-dropdown-open' : ''}`}
              >
                <ul className="nav-dropdown-list">
                  <li>
                    <Link to="/trails" onClick={closeAll}>
                  ...
                  <li>
                    <Link to="/day-passes" onClick={closeAll}>
                      Day Passes
                    </Link>
                  </li>
                  <li>
                    <Link to="/rentals" onClick={closeAll}>
                      Rentals
                    </Link>
                  </li>
                  <li>
                    <Link to="/memberships" onClick={closeAll}>
                      Memberships
                    </Link>
                  </li>
                </ul>
            ...
            <li className="nav-item nav-item-dropdown">
              ...
              >
                <ul className="nav-dropdown-list">
                  <li>
                    <Link to="/event-calendar" onClick={closeAll}>
                      Calendar
                    </Link>
                  </li>
                  <li>
                    <Link to="/upcoming-events" onClick={closeAll}>
                      Upcoming Events
                    </Link>
                  </li>
                  <li>
            ...
            <li className="nav-item">
              <Link to="/location" className="nav-link" onClick={closeAll}>
                Location
              </Link>
            </li>
        ...
        <div className="nav-actions-desktop">
          <button type="button" className="btn btn-webcam-desktop" onClick={openWebcam}>
            Live Webcam
          </button>
          <a
            href="https://buy.stripe.com/9AQ3g1dXm5cc1m83ch"
