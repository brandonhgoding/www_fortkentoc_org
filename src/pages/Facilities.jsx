    ...
    >
      <section id="rentals" className="content-page__section">
        ...
        <p>
          ...
          approximately 30, while the conference room seats approximately 50 and is equipped with a
          digital projector and screen for presentations. WiFi is accessible throughout the entire
          facility, and a well-stocked kitchen is also available. Most local caterers are familiar
          with the amenities of our lodge if you wish to hire out the food services for your event.
          There is a restroom upstairs as well as separate Mens and Ladies facilities in the lower
          level.
        </p>
        <p>
      ...
      <section id="lodge" className="content-page__section">
        ...
        <p>
          ...
          fieldstone fireplace, and a unique perspective of the biathlon stadium. On the lower level
          with access to the stadium is the Rental Shop where no-wax and skating skis as well as
          snowshoes are available for rental. Day or season passes can be purchased there as well as
          online.
        </p>
        <p>
      ...
      <section id="wax-building" className="content-page__section">
        ...
        />
        <p>
          A 27-room wax building was built in 2003 and first used during the IBU World Cup in March
          2004. The lower level is open to the public seven days a week for waxing. Restroom
      ...
      <section id="stadium" className="content-page__section">
        ...
        />
        <p>
          The original Timing Building was moved in 2003 when the Stadium Production room was built.
          A two-story addition was added during fall 2007 in anticipation of the upcoming World Cup.
          This building is situated in front of the competition finish area.
        </p>
      </section>
      ...
      <section id="shooting-range" className="content-page__section">
        ...
        <p>
          ...
          night lighting on 10 targets. The site was awarded the International Biathlon Union Class
          B license in November 2002.
        </p>
      </section>
    </ContentPage>
  );
