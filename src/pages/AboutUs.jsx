    ...
    >
      ...
      <section id="trails" className="content-page__section">
        ...
        <p>
          ...
          pleased members and visitors can now enjoy the beauty of the Maine outdoors all year long.
        </p>
        <p>
          ...
          disc to a basket at the top of Lonesome Pine Trails, watching a toddler learn to ski with
      ...
      <section id="support" className="content-page__section">
        ...
        <p>
          ...
          primarily for training skiers for Biathlon and recreation. With many thanks to uncountable
          volunteer hours, sponsorships from local businesses, various donations large and small,
          and continued support from Pineland Farms we have introduced many other ways for people
          near and far to embrace the outdoors — Disc Golf, single track biking, extended snowshoe
          trails, Nature Series events, Jalbert Ski Program expansion, and many other enhancements
          to our marvelous gem in the St. John Valley.
        </p>
        <p>
