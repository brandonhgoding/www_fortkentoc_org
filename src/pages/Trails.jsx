...
function MapCard({ title, thumbnail, fullSize, alt }) {
  return (
    <a href={fullSize} target="_blank" rel="noopener noreferrer" className="map-card">
          ...
          <div className="container">
            <div className="trails-hero-content">
              ...
              <p>
                ...
                outdoors and discover the extraordinary landscapes that make our trails
                unforgettable.
              </p>
              <div className="hero-buttons">
                <a href="#interactive" className="btn btn-primary">
                  Interactive Nordic Map
                </a>
                <a href="#downloadable" className="btn btn-primary">
        ...
        <div className="container">
          <div className="trails-intro">
            ...
            <p className="content-text">
              ...
              adventure for every season and enthusiast. Whether you're an avid Nordic skier seeking
              the thrill of gliding through pristine snow, a snowshoer craving the tranquility of
              winter landscapes, a mountain biker ready to conquer challenging terrain, or a hiker
              yearning to explore the wonders of the great outdoors, our trails are your gateway to
              unforgettable experiences. With meticulously maintained paths winding through forests
              and meadows, each trail promises a unique journey that immerses you in the natural
              beauty of Fort Kent. Discover the joy of outdoor exploration at our Outdoor Center –
              where every step, pedal, or glide is a celebration of the extraordinary landscapes
          ...
          <div className="two-col-grid">
            <div className="content-col">
              ...
              <p className="content-text text-light">
                Search your favorite app store or use the links below to download the Nordic Pulse
                App
              </p>
