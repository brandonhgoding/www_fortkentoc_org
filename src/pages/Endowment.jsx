  ...
  return (
    ...
    >
      <section id="why" className="content-page__section">
        ...
        <p>
          In 2024 Libra concluded its direct operational support. At that time, the assets belonging
          to the Fort Kent Outdoor Center were formally gifted to our operating Board of Directors.
          For fifteen years, Libra&apos;s support helped cover capital improvements, maintenance,
          taxes, insurance, and half of the venue manager&apos;s salary. That support has now ended,
          making it increasingly difficult to maintain our daily operations and programming.
        </p>
        <p>
          To meet this challenge, FKOC has created an <strong>endowment fund</strong> with the Maine
          Community Foundation to generate annual interest and replace the former contributions.
          Long-time supporter <strong>Phyllis Jalbert</strong> has endorsed the initiative and
          provided the largest contribution to date.
        </p>
        <ul>
      ...
      <section id="progress" className="content-page__section">
        ...
        <p>
          Gifts may be made as one-time donations, multi-year pledges, or via transfers of stock or
          property with favorable tax benefits.
        </p>
      </section>
      ...
      <section id="how" className="content-page__section">
        ...
        <p>
          To help us avoid the 3% credit card processing fee, we kindly encourage donations by check
          whenever possible. Please make checks payable to <strong>FKOC</strong> and mail to:
        </p>
        <address>
