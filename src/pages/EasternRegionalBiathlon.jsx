              ...
              <div className="two-col-grid">
                <div className="content-col">
                  ...
                  <p className="section-intro">
                    ...
                    Cup #2, featuring Sprint races on Saturday and Mass Start races on Sunday. The
                    event is open to all members of USBA or Biathlon Canada in good standing. Please
                    have your current registration card or number available at check-in.
                  </p>
                  <p className="content-text">
                    Competition timing and schedule are subject to change based on registration
                    numbers. A detailed program will be provided at the Team Captain's Meeting on
                    Friday afternoon. Current IBU event and competition rules will be in effect.
                  </p>
                </div>
          ...
          <section className="section">
            <div className="container">
              ...
              <p className="content-text text-center" style={{ marginBottom: 'var(--space-xl)' }}>
                Full class details including distances, loop lengths, targets, and rifle
              ...
              <div className="collection-section" style={{ marginTop: 'var(--space-2xl)' }}>
                ...
                >
                  Mass Start day will be configured as a Mass Start 60. Final groupings decided
                  after registration closes March 25. Start seeding determined by Sprint results.
                </p>
              </div>
            </div>
          </section>
